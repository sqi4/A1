...
client.on("message", async (message) =>{
  ...
  if(!message.member.roles.cache.some(r => r.id == "1079446998865940520")) return;
  ...
  let a = message.guild.roles.cache.find(role => role.id === "1067164384452948021");
  let nota = message.guild.roles.cache.find(role => role.id === "");
  ...
  if(user.roles.cache.some(r=> r.id == a)) return message.channel.send("**الشخص مفعل مسبقاٌ**");
...
.setAuthor("Forever Town RP ™")
.setColor("RED")
.setThumbnail(`https://cdn.discordapp.com/attachments/1200062146248200212/1242466509108809870/FT_Logo.png?ex=6669a01b&is=66684e9b&hm=9a62f23309bed7dc494c5be54abe5cd416c1e96bb1e46a2d9aee248d23c544ac&`)
.setDescription(`** تم تفعيل  ${user} ✅**`)
...
client.user.setActivity("discord.gg/ftrp", {type: "STREAMING", url: "https://discord.com/invite/ftrp"})
